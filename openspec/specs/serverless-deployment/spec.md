# serverless-deployment Specification

## Purpose

Deployment serverless Vercel untuk backend HRIS: entry point serverless, pipeline migrasi produksi, preview deployment dinonaktifkan, dan kontrol flag ENABLE_DOCS.
